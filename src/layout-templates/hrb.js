...
export const hrb = [
    ...
    },
    {
        ...
        content: 'dateFormat(dateFrom.value).monthName.ru'
    },
    {
        width: 60,
        height: 8,
        ...
        content: 'dateFormat(dateFrom.value).weekday.ru'
    },
    {
        width: 35,
        height: 20,
    ...
    },
    {
        ...
        content: 'dateFormat(dateTo.value).monthName.ru'
    },
    {
        width: 60,
        height: 8,
        ...
        content: 'dateFormat(dateTo.value).weekday.ru'
    },
    {
        width: 30,
        height: 20,
